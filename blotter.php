...
<body>
    ...
    <div class="container">
        <div class="navbar">
            <img src="css/images/SystemLogo.png" class="logo"> <h3> | List of Blotter Records</h3>
                <navList>
                    <ulist id="menuList">
                        <list></list>
                        <list></list>
        ...
        <div class="row">
            <div class="col-2">
                    ...
                    $error = NULL;
                        ...
                        //query database
                        $resultSet = $mysqli->query("SELECT * FROM blotter");
                    ...
                    ?>
                                <tr>
                                    ...
                                    <a href="viewblotter.php?id=<?php echo $row['id']; ?>"><span class="material-symbols-outlined operation">visibility</span></a>
