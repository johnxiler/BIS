    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-2">
                <div class="content">
                    <div class="count">
                        <small>Total Number of None Educated:</small>
                        <h2><a href="educationalytics.php"><?php echo $rownone['SUMnone']; ?></a></h2>
                        <small>as of <?php echo $date; ?></small>
                    </div><br><br>

                    <div class="count">
                        <small>Total Number of College Graduate:</small>
                        <h2><a href="educationalytics.php"><?php echo $rowcollege['SUMcollege']; ?></a></h2>
                        <small>as of <?php echo $date; ?></small>
                    </div><br><br>
                </div>
            </div>
