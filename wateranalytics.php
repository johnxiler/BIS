...
<?php
    ...
    if(!$con){
        ...
        $sqlresident = "SELECT COUNT(*) AS SUM FROM households WHERE waterid='$purokid'";
    ...
    $sqlmale = "SELECT COUNT(*) AS SUMMALE FROM households where waterid='1'";
...
<?php include 'navigation.php' ?>
    ...
    <div class="container">
        <div class="navbar">
            <img src="css/images/SystemLogo.png" class="logo"> <h3>| Analytics With Water facility</h3>
                <navList>
                    <ulist id="menuList">
                        <list><a href=""></a></list>
                        <list><a href=""> </a></list>
        ...
        <div class="row">
            <div class="col-1">
                    ...
                    <br>
                    <h4>Total Number of Households <b>with Water Facility:</b></h4>
