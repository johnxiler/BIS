...
<?php   
    ...
    if(isset($_POST["submit"])){
       ...
       $facility = $_POST["facility"];
        ...
        //query database
        $resultCheck = $conn->query("SELECT * FROM services WHERE facility='$facility'");
        $rowsCheck = mysqli_num_rows($resultCheck);
            if ($rowsCheck < 1) {
                $query = "INSERT INTO services VALUES('','$type','$facility')";
                     mysqli_query($conn, $query);
                    $message = "<p style='color:white;background-color:green;border-radius:5px;padding:15px;text-align:center;font-style:bold;'>New Type and Services Added successfully added!</p>";
            }else{
...
<body>
    ...
    <div class="container">
        <div class="navbar">
            <img src="css/images/SystemLogo.png" class="logo"> <h3>| Add Facility Services Category
                    <ulist id="menuList">
                        <list><a href=""> </a></list>
                        <list><a href=""> </a></list>
                        <list><a href=""> </a></list>
        ...
        <div class="row">
            <div class="col-1">
                    <h2>Add Facility<br>Services</h2>
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    <small>Facility Services:</small>
                                    <div class="input-box">
                                        ...
                                        <label>Enter Type of Service:</label>
                                    </div>
                                    <div class="input-box">
                                        <input name="facility" type="text" required>
                                        <label>Enter Provider:</label>
                                    </div>
                                    <?php
                                            echo $message;
                                    ?> 
